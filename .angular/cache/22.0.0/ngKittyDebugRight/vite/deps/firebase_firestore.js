...
var __PRIVATE_LruScheduler = class {
  ...
  Rr(e) {
    __PRIVATE_logDebug(Ct, `Garbage collection scheduled in ${e}ms`), this.Er = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, (() => __async(this, null, function* () {
      this.Er = null;
      try {
        yield this.localStore.collectGarbage(this.garbageCollector);
      } catch (e2) {
        __PRIVATE_isIndexedDbTransactionError(e2) ? __PRIVATE_logDebug(Ct, "Ignoring IndexedDB error during garbage collection: ", e2) : yield __PRIVATE_ignoreIfPrimaryLeaseLoss(e2);
      }
      yield this.Rr(3e5);
    })));
  }
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
   ...
   */
  Gi(e) {
    return this.Li = (t) => __async(this, null, function* () {
  ...
  setDatabaseDeletedListener(e) {
    this.qi.K(((t) => __async(this, null, function* () {
  ...
  setNetworkEnabled(e) {
    ...
    this.Di.enqueueAndForget((() => __async(this, null, function* () {
      this.started && (yield this.Ui());
    }))));
  }
  /**
  ...
  shutdown() {
    return __async(this, null, function* () {
      ...
      yield this.qi.runTransaction("shutdown", "readwrite", [W, Ve], ((e) => {
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  start() {
    return __async(this, null, function* () {
      const e = yield this.syncEngine.ls();
      for (const t2 of e) {
  ...
  js(e) {
    ...
    if (t.storageArea === this.storage) {
      ...
      this.Di.enqueueRetryable((() => __async(this, null, function* () {
        if (this.started) {
          if (null !== t.key) {
            if (this.Ys.test(t.key)) {
              ...
              yield Promise.all(e2.map(((e3) => this.syncEngine.wo(e3))));
            }
          }
        } else this.Hs.push(t);
      })));
  ...
  constructor(e, t, n, r, i) {
    ...
    this.da = [], this.ma = i, this.ma.Fo(((e2) => {
      n.enqueueAndForget((() => __async(this, null, function* () {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(Ht, "Restarting streams for network reachability change."), yield (function __PRIVATE_restartNetwork(e3) {
          return __async(this, null, function* () {
            const t2 = __PRIVATE_debugCast(e3);
            t2.Va.add(
              4
              /* OfflineCause.ConnectivityChange */
            ), yield __PRIVATE_disableNetworkInternal(t2), t2.fa.set(
              "Unknown"
              /* OnlineState.Unknown */
            ), t2.Va.delete(
              4
  ...
  return __async(this, null, function* () {
    if (
      ...
      try {
          ...
          return __async(this, null, function* () {
            ...
            for (const r of t2.targetIds) {
              if (e2.Ta.has(r)) {
                ...
                void 0 !== t3 && (yield e2.remoteSyncer.rejectListen(t3, n2), e2.Ia.delete(t3), e2.Ea.delete(r)), e2.Ta.delete(r);
              }
        ...
        __PRIVATE_logDebug(Ht, "Failed to remove targets %s: %s ", t.targetIds.join(","), n2), yield __PRIVATE_disableNetworkUntilRecovery(e, n2);
      }
      ...
      */
      ...
      __PRIVATE_logDebug(Ht, "Failed to raise snapshot:", t2), yield __PRIVATE_disableNetworkUntilRecovery(e, t2);
    }
  });
}
function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  return __async(this, null, function* () {
    ...
    yield __PRIVATE_disableNetworkInternal(e), e.fa.set(
      "Offline"
      /* OnlineState.Offline */
    ...
    e.asyncQueue.enqueueRetryable((() => __async(null, null, function* () {
      __PRIVATE_logDebug(Ht, "Retrying IndexedDB access"), yield n(), e.Va.delete(
        1
        /* OfflineCause.IndexedDbFailed */
...
function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  return __async(this, null, function* () {
    ...
    n.fa.set(
      "Unknown"
      /* OnlineState.Unknown */
    ), yield n.remoteSyncer.handleCredentialChange(t), n.Va.delete(
      3
      /* OfflineCause.CredentialChange */
...
function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  return __async(this, null, function* () {
    ...
    ), yield __PRIVATE_enableNetworkInternal(n)) : t || (n.Va.add(
      2
      /* OfflineCause.IsSecondary */
    ), yield __PRIVATE_disableNetworkInternal(n), n.fa.set(
      "Unknown"
      /* OnlineState.Unknown */
    ));
  });
...
function __PRIVATE_ensureWatchStream(e) {
  ...
  (e.pa = (function __PRIVATE_newPersistentWatchStream(e2, t, n) {
    ...
    t ? (e.pa.N_(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.fa.set(
      "Unknown"
      /* OnlineState.Unknown */
    )) : (yield e.pa.stop(), __PRIVATE_cleanUpWatchStreamState(e));
  })))), e.pa;
}
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.ya = (function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    yield __PRIVATE_fillWritePipeline(e)) : (yield e.ya.stop(), e.Pa.length > 0 && (__PRIVATE_logDebug(Ht, `Stopping write stream with ${e.Pa.length} pending writes`), e.Pa = []));
  })))), e.ya;
}
...
var __PRIVATE_BundleLoader = class {
  ...
  Za(e) {
    return __async(this, null, function* () {
      const t = yield __PRIVATE_localStoreApplyBundledDocuments(e, new __PRIVATE_BundleConverterImpl(this.serializer), this.ja, this.Ga.id), n = this.Ha(this.documents);
      for (const t2 of this.za) yield __PRIVATE_localStoreSaveNamedQuery(e, t2, n.get(t2.name));
...
function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  return __async(this, null, function* () {
    e.Su = (t2, n2, r2) => (function __PRIVATE_applyDocChanges(e2, t3, n3, r3) {
      return __async(this, null, function* () {
...
function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  return __async(this, null, function* () {
    ...
    })), yield Promise.all(o), r.Eu.J_(i), yield (function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
      return __async(this, null, function* () {
...
function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
  return __async(this, null, function* () {
    ...
    if (!n.currentUser.isEqual(t)) {
      ...
      n.sharedClientState.handleUserChange(t, e2.removedBatchIds, e2.addedBatchIds), yield __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e2.Os);
    }
  });
}
...
function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  return __async(this, null, function* () {
    ...
    if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.wu) {
      ...
      n.wu = true, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
      ...
      })(n), n.wu = false, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
    }
  });
}
  ...
  return __async(this, null, function* () {
    ...
    for (const e2 of t) {
      ...
      if (n2 && 0 !== n2.length) {
        ...
        for (const e3 of n2) {
          const t3 = r.Ru.get(e3), n3 = yield __PRIVATE_synchronizeViewAndComputeSnapshot(r, t3);
  ...
  (function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    return __async(this, null, function* () {
      try {
        ...
        let s = yield t2.vu();
        for (; s; ) {
          const e3 = yield i.Ja(s);
          e3 && n2._updateProgress(e3), s = yield t2.vu();
        }
...
var __PRIVATE_MemoryOfflineComponentProvider = class {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      this.serializer = __PRIVATE_newSerializer(e.databaseInfo.databaseId), this.sharedClientState = this.Fu(e), this.persistence = this.Mu(e), yield this.persistence.start(), this.localStore = this.xu(e), this.gcScheduler = this.Ou(e, this.localStore), this.indexBackfillerScheduler = this.Nu(e, this.localStore);
    });
  }
  Ou(e, t) {
    return null;
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class ___PRIVATE_IndexedDbOfflineComponentProvider extends __PRIVATE_MemoryOfflineComponentProvider {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      yield __superGet(___PRIVATE_IndexedDbOfflineComponentProvider.prototype, this, "initialize").call(this, e), yield this.Bu.initialize(this, e), // Enqueue writes from a previous session
      yield __PRIVATE_syncEngineEnsureWriteCallbacks(this.Bu.syncEngine), yield __PRIVATE_fillWritePipeline(this.Bu.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
      // set it after localStore / remoteStore are started.
      yield this.persistence.Gi((() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve())));
    });
  }
  xu(e) {
    return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
...
var __PRIVATE_MultiTabOfflineComponentProvider = class ___PRIVATE_MultiTabOfflineComponentProvider extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      ...
      // set it after localStore / remoteStore are started.
      yield this.persistence.Gi(((e2) => __async(this, null, function* () {
        yield __PRIVATE_syncEngineApplyPrimaryState(this.Bu.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
      })));
    });
  }
  Fu(e) {
    ...
    return __async(this, null, function* () {
      yield (function __PRIVATE_remoteStoreShutdown(e) {
        return __async(this, null, function* () {
          ...
          ), yield __PRIVATE_disableNetworkInternal(t), t.ma.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var __PRIVATE_BundleReaderImpl = class {
  ...
  vu() {
    return __async(this, null, function* () {
      return yield this.getMetadata(), this.Uu();
    });
  }
  /**
  ...
  Qu(e) {
    return __async(this, null, function* () {
      for (; this.buffer.length < e; ) {
        (yield this.zu()) && this.Wu("Reached the end of bundle when more is expected.");
      }
    ...
    return __async(this, null, function* () {
      ...
      const t = yield (function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
        return __async(this, null, function* () {
          ...
          }, i = yield n.zo("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r, t2.length), s = /* @__PURE__ */ new Map();
          i.forEach(((e3) => {
    ...
    return __async(this, null, function* () {
      ...
      e.forEach(((e2, t) => {
        ...
        return __async(this, null, function* () {
          ...
          yield n.$o("Commit", n.serializer.databaseId, ResourcePath.emptyPath(), r);
        });
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget((() => __async(null, null, function* () {
    ...
    n.ku(), e.asyncQueue.enqueueAndForget((() => __async(null, null, function* () {
...
var __PRIVATE_AsyncQueueImpl = class {
  ...
  Tc() {
    return __async(this, null, function* () {
      if (0 !== this.nc.length) {
        try {
          yield this.nc[0](), this.nc.shift(), this.F_.reset();
        } catch (e) {
